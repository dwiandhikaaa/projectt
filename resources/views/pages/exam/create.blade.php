                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group has-icon-left">
                                            <div class="input-group input-group-merge">
                                                <input id="soal_1" style="text-align: left" name="soal_1" class="form-control" placeholder="Masukkan Kode Soal" type="text" autocomplete="off">
                                                <div class="form-control-icon">
                                                    <i data-feather="server"></i>
                                                </div>
                                                <a href="javascript:void(0)" id="tombol-pilgan" data-id="pilgan" class="search_button btn btn-outline-primary"><i class="fas fa-search"></i></a>
                                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group has-icon-left">
                                            <div class="input-group input-group-merge">
                                                <input id="soal_2" style="text-align: left" name="soal_2" class="form-control" placeholder="Masukkan Kode Soal" type="text" autocomplete="off">
                                                <div class="form-control-icon">
                                                    <i data-feather="server"></i>
                                                </div>
                                                <a href="javascript:void(0)" id="tombol-essay" data-id="essay" class="search_button btn btn-outline-primary"><i class="fas fa-search"></i></a>
                                            </div>
